...
import { Scrole, useTimelineScroll } from "./scrole";
    ...
    <div className="w-full bg-transparent font-sans md:px-10" ref={containerRef}>
      <div className="max-w-7xl mx-auto py-20 px-4 md:px-8 lg:px-10">
        ...
        <p className="text-neutral-700 dark:text-neutral-300 text-sm md:text-base max-w-sm">
          Academic and professional milestones along the way.
        </p>
      </div>
      ...
      <div ref={ref} className="relative max-w-7xl mx-auto pb-20">
        ...
        >
          <Scrole heightTransform={heightTransform} opacityTransform={opacityTransform} />
        </div>
      </div>
    </div>
  );
